...
function FrontendProjectsComponent() {
    return (
        <Container>
                ...
                <Col>
                    <Slide direction="right">
                        ...
                        <header className='project-header'>
                                <svg className='project-links' width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"> <title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
                                <div>
                                    <a href="https://github.com/CodeVinayak/Serverless-Voting-Application" target="_blank" rel="noreferrer">
                                        <img className='project-links' src={githubIcon} alt="Visit site" /></a>
                                    <a href="https://vote.vinayaksingh.com" target="_blank" rel="noreferrer">
                                        <img className='project-links' src={externalLink} alt="Visit site" />
                                    </a>
                                </div>
                            </header>
                            <div className="body">
...
export default FrontendProjectsComponent